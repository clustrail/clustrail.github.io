...
/**
 * The site chrome, matching the app's top bar: canvas-colored sticky bar
 * with a hairline, quiet links, and the one blue CTA on the right.
 */
    ...
    <header className="sticky top-0 z-40 border-b border-border bg-canvas/90 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-5 sm:gap-6">
          ...
          <Link
            href="/#install"
            className="hidden h-9 items-center rounded-lg bg-primary px-4 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 sm:inline-flex">
            Get started
          </Link>
        </div>
      </nav>
